...
<div class="premade-questions-container">
  ...
  >
    <RefreshIcon color="#80B6FF" /> Drugi primjeri
  </button>
</div>
...
<style lang="scss">
  ...
  .premade-questions-container {
    ...
    #refresh-premade-questions-button {
      // $ai-container-button-color: #80b6ff;
      // $ai-container-button-bg: rgba(28, 116, 233, 0.15);
      // $ai-container-button-border: rgba(255, 255, 255, 0.05);
      // $ai-container-button-shadow-color: rgba(0, 0, 0, 0.125);
      margin-top: 0.5rem;
